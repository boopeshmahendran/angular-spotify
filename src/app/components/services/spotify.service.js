...
var SpotifyService = (function () {
    ...
    SpotifyService.prototype.searchMusic = function (str, type) {
        ...
        this.searchUrl = 'https://api.spotify.com/v1/search?query=' + str + '&offset=0&limit=20&type=' + type + '&maket=US';
    ...
    SpotifyService.prototype.getAlbum = function (id) {
        ...
        return this._http.get(this.albumUrl).map(function (res) { return res.json(); });
    };
